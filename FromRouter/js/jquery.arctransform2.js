...
$.fn.arcToggleButton=function(){
var b=$(this).children(".switcher");
var c=b.attr("valOn")||"1",
b=b.attr("valOff")||"0";
var f=$(this).children("input");
if(f[0].checked)
$(this).toggleClass("switchOn");
else
$(this).removeClass("switchOn");};})(jQuery);
$(document).ready(function(){
$(".show_pw").click(function(){
$(".pw-text").each(function(){
if($(".show_pw")[0].checked){
$(this)[0].type="text";}else{
$(this)[0].type="password";}});});
$(".unfold").each(function(){
var tm=$(this);
var headline=tm.find("h2:first");
var hideElement=tm.find("div:first");
hideElement.hide();});
$(".unfold").click(function(){
var tm=$(this);
var headline=tm.find("h2:first");
var hideElement=tm.find("div:first");
if(headline.hasClass('unfold_open')){
headline.removeClass('unfold_open');
hideElement.hide();}
else{
headline.addClass('unfold_open');
hideElement.show();}});
